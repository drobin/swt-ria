 ...
 * {@link GridLayout}. To set a {@link GridData} object into a control, you use
 * {@link Control#setLayoutData(Object)} method.
 * <p>
 * There are two ways to create a GridData object with certain fields set. The
 * first is to set the fields directly, like this:
 *
 * <pre>
 ...
 * </pre>
 *
 * The second is to take advantage of {@link GridData} convenience
 ...
 * </pre>
 *
 * NOTE: Do not reuse {@link GridData} objects. Every control in a Composite
 * that is managed by a {@link GridLayout} must have a unique GridData object.
...
public class GridData extends SWTObject {
   ...
   * {@link SWT#TOP} or {@link SWT#LEFT}instead.
   */
  public static final int BEGINNING = SWT.BEGINNING;

  /**
   * Value for horizontalAlignment or verticalAlignment. Position the control
   * in the vertical or horizontal center of the cell Not recommended.
   * Use {@link SWT#CENTER} instead.
   */
   ...
   *    divided by the number of grabbing columns.
   *  </li>
   *  <li>
   ...
   *    of space missing divided by the number of grabbing columns.
   *  </li>
   *  <li>
   *    If the parent is packed, the cell will be its preferred width as
   *    specified by GridData.widthHint.
   *  </li>
   *  <li>
   *    If the control spans multiple columns and there are no other grabbing
   *    controls in any of the spanned columns, the last column in the span
   *    will grab the extra space. If there is at least one other grabbing
   *    control in the span, the grabbing will be spread over the columns
   *    already marked as grabExcessHorizontalSpace.
   *  </li>
   * </ul>
   *
   ...
   * is <code>true</code>, the following rules apply to the height of the cell:
   *
   * <ul>
   *  <li>
   *    If extra vertical space is available in the parent, the cell will grow
   *    to be taller than its preferred height. The new height will be
   *    "preferred height + delta" where delta is the extra vertical space
   *    divided by the number of grabbing rows.
   *  </li>
   *  <li>
   *    If there is not enough vertical space available in the parent, the cell
   ...
   *    "minimumHeight" and "preferred height - delta", where delta is the
   *    amount of space missing divided by the number of grabbing rows.
   *  </li>
   *  <li>
   *    If the parent is packed, the cell will be its preferred height as
   *    specified by GridData.heightHint.
   *  </li>
   *  <li>
   ...
   *    the extra space. If there is at least one other grabbing control in th
   ...
   * <ul>
   *  <li>
   *    SWT.BEGINNING (or SWT.LEFT): Position the control at the left of the
   *    cell
   *  </li>
   *  <li>
   ...
   * the minimum height will be the result of
   ...
   * that the minimum width will be the result of
   ...
   *  </li>
   *  <li>
   *    WT.END (or SWT.BOTTOM): Position the control at the bottom of the cell
   *  </li>
   *  <li>
  ...
  /**
   * Constructs a new instance based on the GridData style. This
  ...
  /**
   * Constructs a new instance of GridData according to the parameters. A valu
   ...
   *                            within a cell, one of: SWT.BEGINNING
   *                            (or SWT.LEFT), SWT.CENTER, SWT.END
   *                            (or SWT.RIGHT), or SWT.FILL
   * @param verticalAlignment how control will be positioned vertically within
   *                          a cell, one of: SWT.BEGINNING (or SWT.TOP),
   *                          SWT.CENTER, SWT.END (or SWT.BOTTOM), or SWT.FILL
