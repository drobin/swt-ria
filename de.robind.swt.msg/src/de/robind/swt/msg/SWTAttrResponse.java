...
/**
 * The response-message of the {@link SWTOpAttr}-message.
 *
 * @author Robin Doer
 */
public class SWTAttrResponse implements SWTResponse {
   ...
   */
  public SWTAttrResponse(String excClassName, String excMessage)
   ...
   */
  public static SWTAttrResponse success() {
    return (new SWTAttrResponse());
  }
  ...
  public String toString() {
    if (isSuccessful()) {
      ...
      return getClass().getSimpleName() + " [excClass=" + excClass +
